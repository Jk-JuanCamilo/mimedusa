      ...
      <DialogContent className="bg-card border-border sm:max-w-md">
        ...
        {!isConfigured ? (
          <div className="flex flex-col items-center gap-4 py-4 text-center">
            ...
            <div>
              <p className="font-medium text-foreground">Firebase no configurado</p>
              <p className="text-sm text-muted-foreground mt-2">
                Edita <code className="bg-muted px-1 rounded">src/lib/firebase.ts</code> y agrega tus credenciales de Firebase.
              </p>
            </div>
          </div>
        ) : (
